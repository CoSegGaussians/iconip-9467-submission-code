...
We propose CoSegGaussians, which achieves compact neural scene segmentation with only posed RGB images, as shown in the below image(qualititatively in (&#x2160;  <!-- Ⅰ -->) and quantitatively in (II)). Please refer to our paper for more details.
