...
We propose CoSegGaussians, which achieves compact neural scene segmentation with only posed RGB images, as shown in the below image(qualititatively in (&#8544;  <!-- I -->) and quantitatively in (II)). Please refer to our paper for more details.
